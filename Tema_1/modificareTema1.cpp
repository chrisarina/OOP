...
bool Coada_de_caractere::verificare(Nod temp, int numar)
       {
           Nod *temp = NULL;
           temp = first;
           while(temp != NULL)
...
void Coada_de_caractere::push(Nod a)
{
    ...
    else
    {
       ...
       else cout<<"adaugati alt element"<<endl;
     }
    }
...
{   SetConsoleOutputCP(65001);
    ...
    Coada_de_caractere lista1;
    Coada_de_caractere lista2;
    ///apel >> supraincarcat
    cin>>lista1;
    cin>>lista2;
